...
--CREATE FUNCTION dbo.fn_entstokbirimMaliyetTarih (@stokkod varchar(50),@tarih date,@stokmiktar Decimal(12,3)) 
...
WHERE sth_evraktip=3 and sth_stok_kod=@stokkod and sth_tarih<=@satistarih
