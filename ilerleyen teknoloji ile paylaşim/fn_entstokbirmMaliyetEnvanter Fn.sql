...
IF object_id(N'dbo.fn_entstokbirimMaliyetEnvanter', N'FN') IS NOT NULL
DROP FUNCTION dbo.fn_entstokbirimMaliyetEnvanter
GO

CREATE FUNCTION dbo.fn_entstokbirimMaliyetEnvanter (@stokkod varchar(50),@maliyetTarih date,@stokmiktar Decimal(12,3)) 
