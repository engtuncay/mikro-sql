...
GO
CREATE FUNCTION [dbo].[fn_CariTutarlar2]
(@firmalar nvarchar(MAX) = '', @caricins tinyint = 0, @carikod nvarchar(25) = '', @grupno tinyint = null, @ilktar datetime = null, @sontar datetime = null
, @odemeemridegerlemedok tinyint = 0, @SomStr nvarchar(MAX) = '', @ProjeStr nvarchar(MAX) = '')
RETURNS table
AS
RETURN
(
